...
<body id="page-top">
  ...
  <section id="home" class="intro">
          ...
          <div class="container">
            <div class="row" id="capa">
              <div id="intro-img" class="col-lg-5">
                <img src="lib/img/Eu.jpg" alt="Foto de Gustavo Vieira Martins">
              </div>
              <div id="intro-title" class="col-lg-7">
                <h1 class="intro-title">Gustavo Vieira Martins</h1>
                <br>
                    ...
                    <div class="row">
                      <div class="col-sm-8 col-md-8">
                        <div class="perfil-info">
                          <h5 class="title-pf">Perfil</h5>
                            <p><span class="title-s">Nome: </span> <span>Gustavo Vieira Martins</span></p>
                            <p><span class="title-s">Área: </span> <span>Desenvolvedor Front-End</span></p>
                            <p><span class="title-s">Email: </span> <span>gustavoafcavai@gmail.com</span></p>
                            <p><span class="title-s">Telefone: </span> <span>(48) 98445-8420</span></p>
                            <p><span class="title-s">Endereço: </span> <span>Florianópolis, Campeche</span></p>
                            <br>
                            <div class="button-pf">
                              <a id="btCurriculo" class="btn btn-primary" href="lib/docs/curriculo/Currículo.pdf" target="_blank"
                                role="button" data-toggle="tooltip" data-placement="bottom" 
                                title="Clique para visualizar o Currículo em PDF">Currículo</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-8">
                    <div class="sobre_mim">
                      ...
                      <p class="lead">
                        ...
                        <br><br>
                        <span class="space"></span>
                        Quando criança, eu e minha irmã, Victória perdemos nossa mãe para o câncer, e após 4 anos perdemos nosso pai por acidente de carro. Após o infeliz acontecimento, graças a uma família unida, sempre tivemos o apoio dos familiares.
                        <br><br>
                        <span class="space"></span>
        ...
        <div class="col-sm-12">
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/HTML5.png" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>HTML5</h4>
                <div class="certificados-links">
                  <a href="lib/docs/certificados/HTML - IFRS.pdf" target="_blank" title="Mais detalhes"><i class='bx bx-plus bx-tada' ></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/css3.png" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>CSS3</h4>
                <div class="certificados-links">
                  <a href="lib/docs/certificados/CSS - IFRS.pdf" target="_blank" title="Mais detalhes"><i class='bx bx-plus bx-tada' ></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/Flexbox.png" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>Flexbox</h4>
                <div class="certificados-links">
                  <a href="lib/docs/certificados/Flexbox - Alura.pdf" target="_blank" title="Mais detalhes"><i class='bx bx-plus bx-tada' ></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/JavaScript.png" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>JAVASCRIPT</h4>
                <p>Introdução ao Javascript</p>                  
                <div class="certificados-links">
                  <a href="lib/docs/certificados/Lógica de Programação I (Javascript) - Alura.pdf" target="_blank" title="Mais detalhes"><i class='bx bx-plus bx-tada' ></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/bootstrap.png" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>BOOTSTRAP</h4>
                <div class="certificados-links">
                  <a href="lib/docs/certificados/Bootstrap 4 - Udemy.pdf" target="_blank" title="Mais detalhes"><i class='bx bx-plus bx-tada' ></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/react.svg" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>REACT</h4>
                <p>CURSANDO</p>                  
                <!-- <div class="certificados-links">
          ...
          <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/sass-less.png" class="img-fluid" alt="">
              <div class="certificados-info">
            ...
            <div class="cert-box">
            <div class="certificados-wrap">
              <img src="lib/img/Certificados/VUEJS.png" class="img-fluid" alt="">
              <div class="certificados-info">
                <h4>VUE.JS</h4>
                <p>CURSANDO</p>                  
                <!-- <div class="certificados-links">
          ...
          <div class="col-sm-12">
            <div class="box-shadow-full group">
                ...
                <li>
                  ...
                  <div class="chm-img">    
                    <a class="venobox" href="lib/img/CHM.jpg">
                      <img src="lib/img/CHM-no_border.png" class="img-fluid">
                    </a>
                  </div>
                </div> 
    ...
    <section>
      <footer class="bg-dark">
        <div class="copyright-box">
          <div class="credits">
            <p>
              Desenvolvido por Gustavo Vieira Martins
            </p>
    ...
    <script type="text/javascript" src="lib/venobox/venobox.js"></script>
